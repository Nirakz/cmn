...
function updateUserInfo() {
  ...
  $("#input-change-phone").bind("change", function() {
    ...
    if (!regexPhone.test(phone)) {
      alertify.notify("Số điện thoại Việt Nam bắt đầu bằng số 0, giới hạn trong khoảng 10-11 số.", "error", 7);
...
$(document).ready(function() {
  ...
  $("#input-btn-cancel-update-user").bind("click", function() {
    ...
    (originUserInfo.gender === "male") ? $("#input-change-gender-male").attr("checked", true) : $("#input-change-gender-female").attr("checked", true);
